  ...
  return (
    <div className="flex !flex-wrap gap-2 p-2">
      {Array.from({ length: 5 }).map((_, index) => (
        <Card className="w-full cursor-pointer border-2 border-white rounded-md transition-all duration-500 ease-in-out hover:scale-[1.05] md:basis-1/6 lg:basis-1/6 ">
