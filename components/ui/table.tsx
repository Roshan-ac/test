...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn(" !bg-secondaryBackground !h-max", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-max py-2 items-center px-4 text-left align-middle font-medium text-neutral-500 [&:has([role=checkbox])]:pr-0 dark:text-neutral-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-4 py-[9px] align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
