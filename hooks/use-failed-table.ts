...
import { FailedTableInterfaces } from "@/app/(dashboard)/failed/_components/BasePage";
...
export function useFailedTableData<TData, TValue>({
  columns,
  defaultPerPage = 10,
  defaultSort,
  // filterFields = [],
  ...
  const [data, setData] = React.useState<FailedTableInterfaces<TData, TValue>>();
