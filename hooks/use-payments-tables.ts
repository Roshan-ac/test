...
import { z } from "zod";
import { VendorPayementsInterface } from "@/app/(dashboard)/payments/_components/VendorPayment";
...
export function usePaymentsTable<TData, TValue>({
  columns,
  defaultPerPage = 10,
  defaultSort,
  // filterFields = [],
  ...
  const [data, setData] = React.useState<VendorPayementsInterface<TData,TValue>>();
